...
# E6cMMr8vx require optimization to compile
examples: examples/4n7vE3jTh examples/TvxseshGc examples/MMKEdG3or \
 examples/3WsWzfcKK examples/YqnKTT6ds examples/hjMaM3K3Y examples/xeYfn17zG examples/sjbT453dM

examples/4n7vE3jTh: examples/4n7vE3jTh.c lib/libnoplate.a
	$(CC) $(CFLAGS) $(CPPFLAGS) $(LDFLAGS) -o $@ $^
	examples/4n7vE3jTh | md5sum | grep e952d7233d4efeddc809ae617814b021

examples/TvxseshGc: examples/TvxseshGc.c lib/libnoplate.a
	$(CC) $(CFLAGS) $(CPPFLAGS) $(LDFLAGS) -o $@ $^
	examples/TvxseshGc | md5sum | grep 67c4d8fa4a5ee32765a817b5fb7ee0b2

examples/MMKEdG3or: examples/MMKEdG3or.c lib/libnoplate.a
	$(CC) $(CFLAGS) $(CPPFLAGS) $(LDFLAGS) -o $@ $^
	examples/MMKEdG3or | md5sum | grep f799d4d9561d0c8fd0085f12ac7642f8

examples/3WsWzfcKK: examples/3WsWzfcKK.c lib/libnoplate.a
	$(CC) $(CFLAGS) $(CPPFLAGS) $(LDFLAGS) -o $@ $^
	examples/3WsWzfcKK | md5sum | grep 6d7fce9fee471194aa8b5b6e47267f03

examples/YqnKTT6ds: examples/YqnKTT6ds.c lib/libnoplate.a
	$(CC) $(CFLAGS) $(CPPFLAGS) $(LDFLAGS) -o $@ $^
	examples/YqnKTT6ds | md5sum | grep 2df8bfac4665ecf57d9e59efa87adb96

examples/hjMaM3K3Y: examples/hjMaM3K3Y.c lib/libnoplate.a
	$(CC) $(CFLAGS) $(CPPFLAGS) $(LDFLAGS) -o $@ $^
	examples/hjMaM3K3Y | md5sum | grep 91d85da8bb7ad96cd040be4eca026160

examples/xeYfn17zG: examples/xeYfn17zG.c lib/libnoplate.a
	$(CC) $(CFLAGS) $(CPPFLAGS) $(LDFLAGS) -o $@ $^
	examples/xeYfn17zG | md5sum | grep 9ca49815df0df7ace8ab74f10c2ba4a8

examples/sjbT453dM: examples/sjbT453dM.c lib/libnoplate.a
	$(CC) $(CFLAGS) $(CPPFLAGS) $(LDFLAGS) -o $@ $^
	examples/sjbT453dM | md5sum | grep b0e8e34df326ded2c6d06cc53d7a16c3
